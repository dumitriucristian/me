...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark" >
    ...
    <link rel="stylesheet" href="css/style.min.css">
        ...
        <title inertia>{{ config('app.name', 'Laravelss') }}</title>
                        ...
                        <div class="items-center gap-6 hero-content md:flex xl:gap-10">
                            <div class="text-content pt-7 lg:pt-8 max-lg:max-w-[30rem]">
                                <h1
                                 ...
                                 <p>I am your trusted <span class="font-medium text-black dark:text-white/90">IT specialist</span>
                                    offering professional  
                                    <span class="font-medium text-black dark:text-white/90">
                                        technology consultancy</span>,
                                        <span class="font-medium text-black dark:text-white/90"> advice</span>, and 
                                        <span class="font-medium text-black dark:text-white/90">guidance</span> for small and medium-sized businesses.
                                     I specialize in building  <span class="font-medium text-black dark:text-white/90">custom websites</span>,  
                                     <span class="font-medium text-black dark:text-white/90">mobile applications</span>, and 
                                     <span class="font-medium text-black dark:text-white/90">software</span> tailored to your unique needs. 
                                     With extensive experience in  <span class="font-medium text-black dark:text-white/90">cloud infrastructure development</span>
                                      and modern web technologies,
                                      I provide end-to-end solutions that improve efficiency and scalability.</p>
                ...
                <div data-scroll-index="1" id="about">
                    ...
                    <div class="about-section px-5 py-8 md:p-8 bg-white dark:bg-nightBlack rounded-2xl lg:p-10 2xl:p-13">
                        ...
                        <div class="mt-7 md:mt-10 section-title">
                            ...
                            <p>With over 10 years of experience in web and mobile development, I specialized in creating robust and scalable solutions that
                                 meet your business needs. Whether you need a complex web application built with PHP (Laravel) and JavaScript (Vue.js), 
                                 a mobile app powered by Flutter, or seamless cloud integration on AWS or DigitalOcean, I've got you covered.
                            </p>
                            <p>I follow agile development practices (SCRUM) to ensure efficiency, and my process is driven by Behavior-Driven and 
                                Test-Driven Development (BDD/TDD) to guarantee high-quality results. With a strong focus on CI/CD pipelines, 
                                I make sure your project is always ready for deployment, with proper API documentation using Swagger.
                            </p>    
                            <p><a href="" class="dark:text-white">Let’s build something great together!</a></p>
                        </div>
                        <div class="mt-6 section-content">
                            ...
                            <ul class="grid mt-4 mb-10 text-sm lg:mt-6 md:grid-cols-2 gap-x-8 gap-y-3 *:flex *:items-center">
                                <li>
                                    ...
                                    <span class="text-black dark:text-white">+(34) 641 558 435 </span>
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    <span class="flex-[0_0_2rem]">:</span>
                                    <span class="text-black dark:text-white">English, Spanish, Romanian</span>
                                </li>
                            </ul>
                            ...
                            <ul class="grid grid-cols-2 gap-6 counters md:grid-cols-4 xl:gap-8">
                                ...
                                <li>
                                    ...
                                    <div class="text-sm">Programming Languages</div>
                                </li>
                                <li>
                                    <div class="mb-1 text-2xl font-semibold md:text-3xl number text-theme 2xl:text-4xl">
                                        <span>1</span>
                                    </div>
                                    <div class="text-sm">AWS cloud specialization</div>
                                </li>
                            </ul>
                    ...
                    <div class="service-section px-5 py-8 md:p-8 bg-white dark:bg-nightBlack rounded-2xl lg:p-10 2xl:p-13">
                        ...
                        <div class="mb-8 mt-7 md:my-10 section-title">
                            ...
                            <p class="max-w-xl mt-4 md:mt-6 subtitle">
                                I am building and improving custom web environments for businesses. From CRM systems, CMS platforms, and custom frameworks to websites and APIs.
                                I deliver tailored digital solutions that drive efficiency, scalability, and success.
                            </p>
                        </div>
                        ...
                        <div class="grid gap-5 md:gap-6 service-card-wrapper sm:grid-cols-2 lg:gap-7 2xl:gap-8 *:relative *:p-5 *:transition *:duration-300 *:border *:py-7 md:*:p-7 *:border-platinum dark:*:border-metalBlack *:rounded-2xl xl:*:p-8 2xl:*:p-10">
                            ...
                            <div class="card-item group hover:border-theme dark:hover:border-theme">
                                ...
                                <h4 class="mt-5 mb-4 text-xl font-medium text-black dark:text-white xl:text-2xl">
                                    IT Consultancy and Web Optimization
                                </h4>
                                <p>
                                    I design products that are more than pretty. I make them shippable.
                                </p>
                ...
                <div data-scroll-index="3" id="skill">
                    ...
                    <div class="service-section relative px-5 py-8 md:p-8 bg-white dark:bg-nightBlack rounded-2xl lg:p-10 2xl:p-13">
                        ...
                        <div class="mb-8 mt-7 md:my-10 section-title">
                            <h2
                                class="title text-[32px] md:text-4xl lg:text-5xl font-extralight text-black dark:text-white leading-1.27">
                                My <span class="font-semibold text-theme">Teck Stack</span>
                            </h2>
                            <p class="max-w-xl mt-4 md:mt-6 subtitle">
                                I build products that are more than pretty. I make them shippable and usable, ttempor
                                ...
                                <div class="swiper-wrapper *:space-y-5 *:text-center">
                                    <div class="swiper-slide">
                                        <div class="text-center icon">
                                            <img src="/img/skill/figma.svg" class="dark:grayscale" alt="Figma">
                                        </div>
                                        ...
                                        <div class="text-black dark:text-white name">PHP -  LARAVEL</div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="text-center icon">
                                            <img src="/img/skill/webflow.svg" class="dark:grayscale" alt="webflow">
                                        </div>
                                        <div class="progressCircle">
                                            <div class="relative w-32 h-32 mx-auto circle md:w-40 md:h-40"
                                        ...
                                        <div class="text-black dark:text-white name">JAVASCRIPT - VUE</div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="text-center icon">
                                            <img src="/img/skill/tailwind.svg" class="dark:grayscale" alt="TailwindCSS">
                                        </div>
                                        <div class="progressCircle">
                                            <div class="relative w-32 h-32 mx-auto circle md:w-40 md:h-40"
                                                data-percent="90" data-circlefill="#00BC91" data-circleempty="#777777">
                                        ...
                                        <div class="text-black dark:text-white name">Python</div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="text-center icon">
                                            <img src="/img/skill/html.svg" class="dark:grayscale" alt="HTML5">
                                        </div>
                                        <div class="progressCircle">
                                            <div class="relative w-32 h-32 mx-auto circle md:w-40 md:h-40"
                                        ...
                                        <div class="text-black dark:text-white name">GO</div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="text-center icon">
                                            <img src="/img/skill/css.svg" class="dark:grayscale" alt="CSS3">
                                        </div>
                                        <div class="progressCircle">
                                            <div class="relative w-32 h-32 mx-auto circle md:w-40 md:h-40"
                                                data-percent="95" data-circlefill="#00BC91" data-circleempty="#777777">
                                        ...
                                        <div class="text-black dark:text-white name">AWS</div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="text-center icon">
                                            <img src="/img/skill/js.svg" class="dark:grayscale" alt="JavaScript">
                                        </div>
                                        <div class="progressCircle">
                                            <div class="relative w-32 h-32 mx-auto circle md:w-40 md:h-40"
                                        ...
                                        <div class="font-light text-black dark:text-white name">MYSQL</div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="text-center icon">
                                            <img src="/img/skill/jquery.svg" class="dark:grayscale" alt="jQuery">
                                        </div>
                                        <div class="progressCircle">
                                            <div class="relative w-32 h-32 mx-auto circle md:w-40 md:h-40"
                                        ...
                                        <div class="text-black dark:text-white name">GraphQL</div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="text-center icon">
                                            <img src="/img/skill/jquery.svg" class="dark:grayscale" alt="jQuery">
                                        ...
                                        <div class="text-black dark:text-white name">MongoDB</div>
                                    </div>
                                </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="text-center slider-inner md:px-5">
                                            <div class="image flex-center">
                                                <img src="/img/testimonial/author1.png" alt="">
                                            </div>
                    ...
                    <div class="contact-section px-5 py-8 md:p-8 bg-white dark:bg-nightBlack rounded-2xl lg:p-10 2xl:p-13">
                        ...
                        <div class="grid gap-12 mt-8 mb-10 md:my-12 md:grid-cols-12">
                                ...
                                <ul class="contact-info space-y-6 md:space-y-10 2xl:space-y-12 *:flex *:flex-wrap *:items-center *:gap-5">
                                    ...
                                    <li>
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <p class="text-sm">+34 641 558 435</p>
                                        </div>
                                    </li>
                                </ul>
                            ...
                            <div class="md:col-span-7">
                                <form id="contactForm" action="contact-form.php" method="POST" class="space-y-4">
